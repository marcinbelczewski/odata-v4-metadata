...
(function (Edm) {
    ...
    var NavigationPropertyBinding = (function (_super) {
        __extends(NavigationPropertyBinding, _super);
        function NavigationPropertyBinding() {
            _super.apply(this, arguments);
        }
        __decorate([
            parse,
            required, 
            __metadata('design:type', String)
        ], NavigationPropertyBinding.prototype, "path", void 0);
        __decorate([
            parse,
            required, 
            __metadata('design:type', String)
        ], NavigationPropertyBinding.prototype, "target", void 0);
        return NavigationPropertyBinding;
    }(EdmItemBase));
    Edm.NavigationPropertyBinding = NavigationPropertyBinding;
    ...
    var EntitySet = (function (_super) {
        ...
        __decorate([
            parseAs(mapArray("navigationPropertyBinding", function (prop, i) { return new NavigationPropertyBinding(prop, i); })), 
            __metadata('design:type', Array)
        ], EntitySet.prototype, "navigationPropertyBindings", void 0);
        __decorate([
            parseAs(mapArray("annotation", function (prop, i) { return new (annotationTypeSelector(prop))(prop, i); })), 
            __metadata('design:type', Array)
